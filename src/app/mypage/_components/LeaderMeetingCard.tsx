...
export interface LeaderMeetingCardProps {
    ...
    <div className="rounded-xl border bg-white space-y-3 p-5 shadow-sm text-xs w-full">
        ...
        <div className="space-y-3">
          ...
          <div className="flex justify-between items-center">
            <div className="space-x-2">
              <span
                className={`font-semibold ${isDone ? "text-gray-500" : "text-accent-main"}`}
              >
                {status}
              </span>
              <span className="text-base text-gray-600">
                <span className="font-medium">마감</span> {application_deadline}
              </span>
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-x-4 gap-y-1 text-gray-600 text-base">
            <div>
              <span className="font-medium text-gray-700">활동 일시</span>{" "}
              {date}
            </div>
            <div>
            ...
            <div>
              <span className="font-medium text-gray-700">모임 횟수</span>{" "}
              {session_count}회
            </div>
          </div>
        </div>
      ...
      <div className="flex justify-between items-center rounded-md p-3 text-xs bg-orange-50">
        ...
        <MoreLinkButton
          href={
            isDone
              ? `/mypage/mymeet/${id}/review`
              : "/mypage/mymeet/${id}/applicants"
          }
        >
