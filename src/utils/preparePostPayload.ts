...
function isUploadedFile(file: File | { id: number } | null | undefined): file is { id: number } {
  return typeof file === 'object' && file !== null && 'id' in file && typeof file.id === 'number';
}

export const preparePostPayload = async (formData: PostFormData): Promise<PostCreatePayload> => {
